...
import com.example.oxalis.databinding.FragmentDetailSheetBookTourUserCancelBinding
...
class DetailSheetBookTourUserCancelFragment(private val sheetBookTour: SheetAddInformationCart, private val tourInfo: TourInfo) : Fragment() {

    private var _binding: FragmentDetailSheetBookTourUserCancelBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDetailSheetBookTourUserCancelBinding.inflate(inflater,container,false)
